Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6cfd00d44db20f04ca106b67f18a6594"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (81.08 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0,0.003860239,1,1);
				#ifdef POI_AUDIOLINK
				...
				float emission = (13.0 /*_OutlineEmission*/);
				#ifdef POI_AUDIOLINK
				if (poiMods.audioLinkAvailable)
				{
